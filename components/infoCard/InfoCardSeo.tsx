  ...
  return (
    ...
    >
      <div class="hidden lg:flex items-center justify-center w-[132px]">
        <Icon id="LogoSeoBF" height={160} width={132} class="w-full" />
      </div>
      <div class="lg:hidden flex items-center justify-between w-full mb-4">
        <Icon id="LogoSeoBF" height={100} width={83} />
      ...
      <div class="lg:pl-[60px] lg:border-l border-[#DEE0E8] w-full">
        <h3 class="hidden lg:block text-main-bf-theme font-medium text-base mb-2">
          {title}
        </h3>
        {html
          ? (
            <div
              ...
              class="text-main-bf-theme font-normal text-xs m-auto max-lg:text-justify"
            />
          )
          : null}
      </div>
