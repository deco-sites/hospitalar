...
const ResultSearch = ({ valueSearch, notFound, cardLayout, suggestions, loading }: ResultSearch) => {
    if (valueSearch !== "" && suggestions?.value != null) {
        return (
            <div className="md:absolute md:w-full md:top-[100px] bg-white md:left-0 md:container md:m-auto md:px-5 z-40">
