    ...
    return (<div class="container mx-auto w-full px-5 lg:px-0 mb-8">
      ...
      <div class="flex flex-col lg:flex-row gap-12 px-2 lg:px-0">
        ...
        <div class="flex flex-col items-center justify-center w-full lg:w-[70%]">
          ...
          <div class={`searchnotfound relative grid grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-5 items-start mt-[20px] `}>
            {products?.map((product, index) => (<div class="w-full list-none ">
                <ProductCard product={product} preload={index === 0} layout={{
            ...
            }} IdCollection={"156"} tagWarningWidth="70%" positionBottom="bottom-0" classFrreShipping="hidden lg:block"/>
              </div>))}
          </div>
        </div>
      </div>
