...
const DescriptionCard = (
    ...
    return (
        <div class={`mt-[30px] ${classContainer}`}>
            ...
            <div class="px-5 mt-5">
                <div
                    class={`relative font-poppins not-italic font-bold text-sm text-[#8E8E9F] lg:text-base overflow-hidden ${isOpen ? "h-auto" : "h-[225px]"
                        }`}
                >
                    ...
                    {(!isOpen) && (
                        <div
                            style={{
                                background:
                                    "linear-gradient(to top, #FAFAFB, #FAFAFA 5%, transparent 75%)",
                            }}
                            class="w-full h-[150px] absolute bottom-0 left-0 z-20"
                        >
                        </div>
                    )}
                </div>
