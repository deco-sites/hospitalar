      ...
      >
        {slideTwoRow
          ? (
            <Slider
              class={clx(
                `container carousel carousel-start flex max-lg:overflow-hidden`,
              )}
            >
              ...
              {slideTwoRow && device === "desktop" &&
                redesignArray(products).map((produtosInternos, index) => {
                  return (
                    <Slider.Item
                      index={index}
                      class={clx(
                        `carousel-item w-[calc(100%_/_4)] flex flex-col`,
                      )}
                    >
          ...
          : (
            <Slider
              class={clx(
                `container carousel carousel-start gap-6 col-span-full row-span-full py-2 mb-8 lg:mb-0'}`,
              )}
            >
              {products?.map((product, index) => {
                return (
                  <Slider.Item
                    index={index}
                    class={clx(
                      `carousel-item lg:w-[270px] ${
                        slideTwoRow ? "max-lg:w-[335px]" : ""
                      }`,
                    )}
                  >
                    <NewProductCard
        ...
        <>
          <div
            class={clx(
              `flex items-center justify-center z-10 col-start-1 row-start-2  ${
                CONDITIONAL_RESPONSIVE_PARAMS[
              ...
              ${
                slideTwoRow
                  ? "absolute top-2/4 -translate-y-1/2 max-lg:left-5"
                  : ""
              }`,
            )}
          >
          ...
          <div
            class={clx(
              `flex items-center justify-center z-10 col-start-3 row-start-2 ${
                CONDITIONAL_RESPONSIVE_PARAMS[
                  showPaginationArrows ? showPaginationArrows : "Always"
                ]
              }
              ${
                slideTwoRow
                  ? "absolute top-2/4 -translate-y-1/2 lg:right-0 right-5"
                  : ""
              }`,
            )}
          >
